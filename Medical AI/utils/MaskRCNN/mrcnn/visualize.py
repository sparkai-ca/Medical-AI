...
def process_image(image, boxes, masks, class_ids, scores, class_names, filter_classs_names=None,
               scores_thresh=0.5, save_dir=None, mode=1):
    """
        image: image array
...
#         image.save(os.path.join(save_dir, '%s.jpg' % (image_name)))
    else:
#         assert boxes.shape[0] == masks.shape[-1] == class_ids.shape[0]
    ...
    if mode == 3:
        # masked_image.save(os.path.join(save_dir, '%s.jpeg' % (image_name)))
        return masked_image
