...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        # print("--------------->",config.IMAGE_CHANNEL_COUNT)
        # Inputs
        input_image = KL.Input(
            shape=[None, None, config.IMAGE_CHANNEL_COUNT], name="input_image")
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        layer_regex = {
            ...
            "heads": r"(conv0)|(mrcnn\_.*)|(rpn\_.*)|(fpn\_.*)",
            # All layers
            "all": ".*",
        }
        if self.config.BACKBONE in ["resnet50", "resnet101"]:
            # From a specific Resnet stage and up
            stage_regex = { "3+": r"(res3.*)|(bn3.*)|(res4.*)|(bn4.*)|(res5.*)|(bn5.*)|(rpn\_.*)|(fpn\_.*)",
                            "4+": r"(res4.*)|(bn4.*)|(res5.*)|(bn5.*)|(rpn\_.*)|(fpn\_.*)",
                            "5+": r"(res5.*)|(bn5.*)|(rpn\_.*)|(fpn\_.*)" }
            ...
            # Chnage by Ifrah (Remove mask layer)
            stage_regex = { "3+": r"(conv.*5.*)|(conv.*6.*)|(conv.*7.*)|(conv.*8.*)|(conv.*9.*)|(conv.*10.*)|(conv.*11.*)|(conv.*12.*)|(conv.*13.*)|(rpn\_.*)|(fpn\_.*)",
                            "4+": r"(conv.*11.*)|(conv.*12.*)|(conv.*13.*)|(bn4.*)|(mob5.*)|(bn5.*)|(rpn\_.*)|(fpn\_.*)",
                            "5+": r"(conv.*13.*)|(rpn\_.*)|(fpn\_.*)" }
